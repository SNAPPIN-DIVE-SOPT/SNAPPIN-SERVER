...
public class ProductAvailableLocation extends BaseEntity {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "product_available_location_seq_gen")
    @SequenceGenerator(
        name = "product_available_location_seq_gen",
        sequenceName = "product_available_location_seq",
        allocationSize = 1
    )
    private Long id;
